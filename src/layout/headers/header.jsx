                        ...
                        <div className="header-navbar">
                            <div className="header-brand">
                                <div className="logo">
                                    <Link href={'/'}>
                                        <a>
                                            <img className="logo-light logoo" src='/assets/images/logo/loogo.png' alt="logo" />
                                            <img className="logo-dark logoo" src='/assets/images/logo/loogo.png' alt="logo" />
                                        </a>
                                    </Link>
                                </div>
                                ...
                                <ul className="header-action">
                                    ...
                                    <li className="header-btn">
                                        <Link href="/contact-us">
                                            <a className="edu-btn btn-medium">Contact Us
